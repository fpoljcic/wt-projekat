...
describe('Kalendar', function() {
	describe('iscrtajKalendar()', function() {
		...
		it('Pozivanje iscrtajKalendar za trenutni mjesec: očekivano je da je 1. dan u srijedu', function() {
			var kalendar = document.getElementById("kalendarRef");
			...
			assert.equal(i, 2, "1. dan januara se nalazi u 3. redu (indeks = 2)");
			assert.equal(j, 6, "1. dan januara se nalazi u 7. koloni (indeks = 6)");
		});

		it('Pozivanje iscrtajKalendar za trenutni mjesec: očekivano je da je 30. dan u cetvrtak', function() {
			var kalendar = document.getElementById("kalendarRef");
			...
			assert.equal(i, 7, "30. dan novembra se nalazi u 8. redu (indeks = 7)");
			assert.equal(j, 0, "30. dan novembra se nalazi u 1. koloni (indeks = 0)");
		});
		...
		it('Pozivanje iscrtajKalendar za januar: očekivano je da brojevi dana idu od 1 do 31 počevši od utorka', function() {
			...
			assert.equal(kolonaPrvog, 2, "1. dan januara se nalazi u 3. koloni (indeks = 2)");
		});

		it('Moj test 1: Testiranje februara, ima 29 dana, zadnji je u subotu', function() {
			var kalendar = document.getElementById("kalendarRef");
			...
			assert.equal(redZadnjeg, 6, "28. dan februara se nalazi u 7. redu (indeks = 6)");
			assert.equal(kolonaZadnjeg, 4, "28. dan februara se nalazi u 5. koloni (indeks = 4)");
			assert.equal(brojac, 29, "Mjesec februar ima 29 dana");
		});
		...
		it('Moj test 2: Testiranje rednog broja za svaki ponedjeljak u mjesecu julu', function() {
			...
			for (var i = 3; i < kalendar.rows.length - 1; i++) {
				assert.equal(kalendar.rows[i].cells[0].innerHTML, (i - 2) * 7 - 1, (i - 2) + ". ponedjeljak se nalazi u " + (i + 1) + ". redu (indeks = " + i + "), 1. koloni (indeks = 0)");
			}
		});
	});
	...
	describe('obojiZauzeca()', function() {
		...
		it('Pozivanje obojiZauzeca gdje u zauzecima postoje duple vrijednosti za zauzeće istog termina: očekivano je da se dan oboji bez obzira što postoje duple vrijednosti', function() {
			var kalendar = document.getElementById("kalendarRef");
			var vanredna = [{datum: "01.01.2020", pocetak: "10:00", kraj: "12:00", naziv: "0-01", predavac: "Faris"},
			{datum: "01.01.2020", pocetak: "10:00", kraj: "12:00", naziv: "0-01", predavac: "Armin"},
			{datum: "28.01.2020", pocetak: "10:00", kraj: "12:00", naziv: "0-01", predavac: "Amra"},
			{datum: "30.01.2020", pocetak: "10:00", kraj: "12:00", naziv: "0-01", predavac: "Sile"},
			{datum: "30.01.2020", pocetak: "10:00", kraj: "12:00", naziv: "0-01", predavac: "Adin"}];
			Kalendar.ucitajPodatke(null, vanredna);
			Kalendar.obojiZauzeca(kalendar, 0, "0-01", "10:00", "12:00");
		...
		it('Pozivanje obojiZauzece kada u podacima postoji zauzeće termina ali u drugom mjesecu: očekivano je da se ne oboji zauzeće', function() {
			var kalendar = document.getElementById("kalendarRef");
			var vanredna = [{datum: "01.12.2020", pocetak: "20:00", kraj: "22:00", naziv: "VA1", predavac: "Faris"},
			{datum: "31.12.2020", pocetak: "20:00", kraj: "22:00", naziv: "VA1", predavac: "Armin"},
			{datum: "02.03.2020", pocetak: "20:00", kraj: "22:00", naziv: "VA1", predavac: "Amra"},
			{datum: "07.07.2020", pocetak: "20:00", kraj: "22:00", naziv: "VA1", predavac: "Sile"},
			{datum: "07.11.2020", pocetak: "20:00", kraj: "22:00", naziv: "VA1", predavac: "Adin"}];
			Kalendar.ucitajPodatke(null, vanredna);
		...
		it('Dva puta uzastopno pozivanje obojiZauzece: očekivano je da boja zauzeća ostane ista', function() {
			var kalendar = document.getElementById("kalendarRef");
			var vanredna = [{datum: "01.01.2020", pocetak: "07:00", kraj: "09:00", naziv: "MA", predavac: "Faris"},
			{datum: "21.01.2020", pocetak: "07:00", kraj: "09:00", naziv: "MA", predavac: "Armin"},
			{datum: "30.01.2020", pocetak: "07:00", kraj: "09:00", naziv: "MA", predavac: "Amra"}];
			...
			// 1. poziv - PERIODICNA
			Kalendar.obojiZauzeca(kalendar, 0, "MA", "07:00", "09:00");
			for (var i = 2; i < kalendar.rows.length; i++) {
				for (var j = 0; j < kalendar.rows[i].cells.length; j++) {
		...
		it('Pozivanje ucitajPodatke, obojiZauzeca, ucitajPodatke - drugi podaci, obojiZauzeca: očekivano da se zauzeća iz prvih podataka ne ostanu obojena, tj. primjenjuju se samo posljednje učitani podaci', function() {
			var kalendar = document.getElementById("kalendarRef");
			var vanredna = [{datum: "01.02.2020", pocetak: "14:00", kraj: "14:30", naziv: "1-09", predavac: "Faris"},
			{datum: "07.02.2020", pocetak: "14:00", kraj: "14:30", naziv: "1-09", predavac: "Armin"},
			{datum: "20.02.2020", pocetak: "14:00", kraj: "14:30", naziv: "1-09", predavac: "Amra"},
			{datum: "25.02.2020", pocetak: "14:00", kraj: "14:30", naziv: "1-09", predavac: "Sile"}];
			Kalendar.ucitajPodatke(null, vanredna);
			...
			vanredna = [{datum: "11.02.2020", pocetak: "14:00", kraj: "14:30", naziv: "1-09", predavac: "Faris"},
			{datum: "14.02.2020", pocetak: "14:00", kraj: "14:30", naziv: "1-09", predavac: "Armin"},
			{datum: "26.02.2020", pocetak: "14:00", kraj: "14:30", naziv: "1-09", predavac: "Amra"},
			{datum: "27.02.2020", pocetak: "14:00", kraj: "14:30", naziv: "1-09", predavac: "Sile"}];
			Kalendar.ucitajPodatke(null, vanredna);
			Kalendar.obojiZauzeca(kalendar, 1, "1-09", "14:00", "14:30");
		...
		it('Moj test 1: Test intervala, filtriranje od 10:00 do 14:00, zauzeće 1 stavljeno od 12:00 do 14:00, zauzeće 2 od 14:00 do 16:00', function() {
			var kalendar = document.getElementById("kalendarRef");
			var vanredna = [{datum: "05.11.2020", pocetak: "12:00", kraj: "14:00", naziv: "1-08", predavac: "Faris"},
							{datum: "06.11.2020", pocetak: "14:00", kraj: "16:00", naziv: "1-08", predavac: "Amir"}];
			Kalendar.ucitajPodatke(null, vanredna);
